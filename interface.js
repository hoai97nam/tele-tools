...
async function p(e, t) {
    ...
    const s = await fetch("https://a.com/bulktele/subscriptionverify.php?email=" + e + "&sessioncode=" + t, n);
...
async function b(e) {
    ...
    const n = await fetch("https://a.com/bulktele/sendmanagesubemail.php?email=" + e, t);
...
async function B(e, t) {
    ...
    const s = await fetch("https://a.com/bulktele/portaldirect.php?email=" + e + "&sessioncode=" + t, n);
    console.log("https://a.com/bulktele/portaldirect.php?email=" + e + "&sessioncode=" + t);
    if (s["ok"] == false) {
        var a = [];
        a["status"] = "error"
    } else {
...
async function f(e) {
    ...
    const n = await fetch("https://a.com/bulktele/sendlogincode.php?email=" + e, t);
    const s = await n.json();
    return s.status
}
async function v(e, t) {
    ...
    const s = await fetch("https://a.com/bulktele/logincodeverify.php?email=" + e + "&logincode=" + t, n);
    const a = await s.json();
    return a
}
async function C() {
...
async function I(e, t) {
    ...
    const s = await fetch("https://a.com/bulktele/endsession.php?email=" + e + "&sessioncode=" + t, n);
    const a = await s.json();
    return a.status
}
...
var firstRegister = async function (accName) {
    ...
    if (status[accName].expireDate == "") {
        status[accName].expireDate = signUpTime() + (1000 * 3600 * 24 * 36500);
        await a({ 'usr': status });
    }
}
